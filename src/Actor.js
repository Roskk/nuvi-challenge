        ...
        <div className="actor-container"> 
          ...
          <div className="likes-comments">
            <svg onClick={this.toggleLike} className="like-activity" xmlns="http://www.w3.org/2000/svg" width="460" height="425" viewBox="0 0 460 425">
              <path className="heart-color" d="M1.416 121.146c0 134.755 135.933 170.087 228.562 303.308C317.552 292.05 458.54 251.6 458.54 121.146c0-66.24-53.76-120-120-120-48.047 0-89.4 28.37-108.562 69.187-19.16-40.817-60.514-69.187-108.562-69.187-66.24 0-120 53.76-120 120z" stroke="#000" fillRule="nonzero" fill={this.state.like ? '#ff7d7d' : '#FFF'} />
            </svg>
